...
CREATE TABLE `vehicles` (
  ...
  `tagID` char(9) NOT NULL,
  `providerAbbr` char(2) DEFAULT NULL,
  `licenseYear` char(4) DEFAULT NULL,
  `tagProvider` varchar(20) DEFAULT NULL,
...
-- Dump completed on 2021-12-14 19:22:47
